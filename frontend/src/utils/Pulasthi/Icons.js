...
export const budget= <i class="fa-solid fa-scale-balanced"></i>
export const income = <i class="fa-solid fa-money-bill-trend-up"></i>
...
export const dollar = <i class="fa-solid fa-rupee-sign"></i>
